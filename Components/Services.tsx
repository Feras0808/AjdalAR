...
export default function Services() {
  const [arService, setArService] =
    useState<ARService | null>(null);
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 leading-8 text-neutral-600">
              Complete painting and vehicle appearance solutions
              delivered with professional workmanship and attention
              to detail.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="px-7 pb-9 pt-12">
                    ...
                    {/* AR BUTTON — ONLY TWO SERVICES */}
                    {service.ar && (
                      <button
                        type="button"
                        onClick={() =>
                          setArService(
                            service.title as ARService
                          )
                        }
                        className="
                          mt-6
